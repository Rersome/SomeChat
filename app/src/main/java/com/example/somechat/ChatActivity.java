...
public class ChatActivity extends AppCompatActivity {
    ...
    private SomeMessageAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Talking with " + recipientUserName);
        ...
        final List<SomeMessage> someMessages = new ArrayList<>();
        adapter  = new SomeMessageAdapter(this, R.layout.message_item, someMessages);
        ...
        messagesChildEventListener = new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                SomeMessage message = dataSnapshot.getValue(SomeMessage.class);
